...
This data contains citibike ride information for two months in different seasons, Jan and July in two different years, 2020 and 2024. There is a total of `r count(citibike_full)` rides recorded in this data with a mean ride duration of rides under 4 hours of `r mean(pull(citibike_full,duration))` . The breakdown of these measures by month and year can be seen below 
