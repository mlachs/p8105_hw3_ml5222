...
![](p8105_hw3_ml5222_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
citibike_full %>% 
  filter(year==2024) %>% 
  ggplot(aes(x=month,y=duration,fill = rideable_type))+geom_boxplot()+facet_grid(~member_casual)
```

![](p8105_hw3_ml5222_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
