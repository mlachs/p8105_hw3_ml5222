...
rides under 4 hours of 13.9301375 . The breakdown of these measures by
month and year can be seen below
...
```
    ...
    ## # A tibble: 4 × 4
    ## # Groups:   month [2]
    ##   month  year count mean_duration
    ##   <chr> <dbl> <int>         <dbl>
    ## 1 Jan    2020 12420          11.9
    ## 2 Jan    2024 18861          10.7
    ## 3 July   2020 21048          19.0
    ## 4 July   2024 47156          13.5
